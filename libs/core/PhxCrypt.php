...
class PhxCrypt
{
    ...
    protected static $_phx_key = array("phxAlg"=>"twofish","phxKey"=>"8031e6ac94b4a75db83c85c23e209143","cut_length"=>5);
	...
	{
        if ($_SERVER['SERVER_ADDR'] != '127.0.0.1' && $_SERVER['SERVER_ADDR'] != '192.168.6.222' && $iscut == false){
